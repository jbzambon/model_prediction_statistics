% mps_corrcoef.m
%   Program to compute Correlation Coefficient (r) between observed and predicted values
%
% model_prediciton_statistics: mps_corrcoef.m
